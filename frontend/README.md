...
Repo root: `/srv/bfd/Projects/bfd-setter/` (back-compat symlink at `/srv/bfd/Projects/1prompt-os/`). Canonical project README: [`../README.md`](../README.md). Deployment topology + Railway env reference: [`../SOP/RUNBOOK.md`](../SOP/RUNBOOK.md) and [`../Docs/RAILWAY_ENV.md`](../Docs/RAILWAY_ENV.md).
