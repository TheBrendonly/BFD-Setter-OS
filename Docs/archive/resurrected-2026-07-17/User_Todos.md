...
>
> This file was deliberately deleted from the repo in commit `29df857 (docs: reconcile all tracking into 5 canonical lists)`, then
...
>
> **Superseded by:** `Docs/archive/User_Todos_archived_2026-06-25.md (a later, fuller 898-line snapshot; this resurrected copy is only 510 lines)`
>
